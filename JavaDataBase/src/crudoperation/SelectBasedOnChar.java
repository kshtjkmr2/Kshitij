...
public class SelectBasedOnChar {
	...
	public static void main(String[] args) {
		...
		try {
			...
			System.out.println("Enter Initial charecter of employee");
			String ch = sc.next()+"%";
			
			String qString = String.format("select * from employee where ename like '%s'",ch);
